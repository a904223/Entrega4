...
public class busqueda_customers2 extends HttpServlet {
   ...
   public void doGet (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "SELECT CIF, Telephone, Email FROM Customers WHERE CustomerName LIKE '" + ValorStr + "'";
            String sql2 = "SELECT ProductName FROM OwnProducts";
            String sql3 = "SELECT count(*) As count FROM OwnProducts";
			...
			out.println("<form action='saveCustomer' name='saveCustomer'>");
            ...
            out.println("<table cellspacing='1' cellpadding='1' border='1' align='center' width='80%';>");
                ...
                out.println("<tbody>");
                   out.println(" <tr>");
                        ...
                        out.println("<td align='left'><input type='text' id='CustomerName' value=\"" + ValorStr + "\" name='CustomerName' size='30' /></td>");
