...
public class searchCustomerOrders extends HttpServlet {
   ...
   public void doGet (HttpServletRequest req, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "SELECT CustomerName, CIF, Telephone, Email, AccountingDate, DeliveryDate FROM CustomerOrders WHERE OrderID LIKE " + strOrderID + "";
            String sql2 = "SELECT count(*) As veces FROM OrderLines2 WHERE OrderID LIKE " + strOrderID + "";
			...
			String strCustomerName = result.getString("CustomerName");
			System.out.println("CustomerName :" + strCustomerName);
			...
			String sql3 = "SELECT ProductName, Quantity, UnitPrice, TotalPrice FROM OrderLines2 WHERE OrderID LIKE " + strOrderID + "";
                ...
                out.println("<tbody>");
                   out.println(" <tr>");
                    ...
                    out.println("<tr>");
                        ...
                        out.println("<td align='left'><input type='text' id='Telephone' value=\"" + strCustomerName + "\" name='Telephone' size='20' /></td>");                
