...
public class busqueda_clientes extends HttpServlet {
   ...
   public void doGet (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql = "SELECT SupplierName FROM Suppliers WHERE SupplierName LIKE ?";
			String sql2 = "SELECT Count(SupplierName) AS cuenta FROM Suppliers WHERE SupplierName LIKE ?";
            ...
            if (Cont !=0){
                ...
                while (result.next()){
                    SqlSupplier = result.getString("SupplierName");
                    i++;
                    out.println("<tr><td>" + SqlSupplier + "</td></tr>");
                }
                out.println("</table>");
            }
			out.flush();
