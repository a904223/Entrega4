...
public class ModWarehouse extends HttpServlet {
  ...
  public void doGet (HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
	...
	toClient.println("<h1 align=\"center\">MODIFY WAREHOUSE</h1>");
	...
	toClient.println("<form method=\"get\" action=\"UpdateWarehouse\" >");
	toClient.println("<table cellspacing=\"1\" cellpadding=\"1\" border=\"0\" align=\"right\" width=\"80%\" summary=\"\">");
	toClient.println("<tbody>");
	toClient.println("<tr>");
	toClient.println("<td><font face=\"Agency FB\">Warehouse Id</font></td>");
	toClient.println("<td align=\"left\">" +Id+ "</td>");
	toClient.println("</tr>");
	toClient.println("<input type=\"Hidden\" name=\"Id\"  value=\""+Id+"\"/>");
	toClient.println("<tr>");
	toClient.println("<td><font face=\"Agency FB\">Warehouse Name</font></td>");
	toClient.println("<td align=\"left\"><input type=\"text\" name=\"Name\" value=\"" + Name + "\" ></td>");
	toClient.println("</tr>");
	toClient.println("<tr>");
	toClient.println("<td><font face=\"Agency FB\">Adress</font></td>");
	toClient.println("<td align=\"left\"><input type=\"text\" name=\"Adress\" value=\"" + Adress + "\" ></td>");
	toClient.println("</tr>");
	toClient.println("<td align=\"left\"><INPUT class=\"boton grisn\" TYPE=\"submit\" value=\"Update Warehouse\"></td>");
	...
	toClient.println("	<font color=\"black\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"warehouses\">Cancel</a></font>");
