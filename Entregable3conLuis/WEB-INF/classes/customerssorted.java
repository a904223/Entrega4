...
public class customerssorted extends HttpServlet {
  ...
  public void doGet (HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
   ...
   try {
            ...
            ResultSet result = statement.executeQuery("Select CustomerID,CustomerName,CIF,Telephone,Email FROM Customers WHERE CustomerName like '%" + Name +"%'");
   
   while (result.next()) {
        
		String Id=result.getString("CustomerID");
		String CIF=result.getString("CIF");
		String Namo=result.getString("CustomerName");
