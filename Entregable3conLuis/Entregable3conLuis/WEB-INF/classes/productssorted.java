...
public class productssorted extends HttpServlet {
  ...
  public void doGet (HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
   ...
   try {
            ...
            ResultSet result = statement.executeQuery("Select ProductId,Product_Name,Sell_Price,Buy_Price FROM Products WHERE Product_Name like '%" + Name +"%'");
   
   while (result.next()) {
        
		String Id=result.getString("ProductId");
		String Sell=result.getString("Sell_Price");
		String Namo=result.getString("Product_Name");
