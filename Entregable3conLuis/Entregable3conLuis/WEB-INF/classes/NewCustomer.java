...
public class NewCustomer extends HttpServlet {
  ...
  public void doGet (HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		String sql = "INSERT INTO Customers ( CustomerName, CIF, Telephone, Email) VALUES ('";
		sql +=    Name+"'" ;
		sql +=  ", '" + CIF + "'";
		sql +=  ", '" + TLF + "'";
		sql +=  ", '" + Email + "')";
	   System.out.println("Insert sql: " + sql);
        try{
            ...
            e.printStackTrace();
            System.out.println("Error addding new Customer: " + e);
        }
    ...
    toClient.println("<TITLE>CUSTOMER</TITLE>");
	...
	toClient.println("<h1 align=\"center\">New Customer:</h1>");
    toClient.println("<P><FONT face=Agency FB size=+1><B>Customer Name: </B>" + Name + "</FONT>");
    ...
    toClient.println("<BR><a style=\"font-size:24px\" href=\"customers\">Back to Customers</a>");
