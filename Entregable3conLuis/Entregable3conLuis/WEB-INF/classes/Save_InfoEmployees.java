...
public class Save_InfoEmployees extends HttpServlet {
   ...
   public void doPost (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            System.out.println("date_of_birth2[0]: " + date_of_birth2[0]);
            System.out.println("date_of_birth2[1]: " + date_of_birth2[1]);
            System.out.println("date_of_birth2[2]: " + date_of_birth2[2]);
            ...
            for (int a = 0; a < lim; ++a) {
                ...
                System.out.println("date_of_birth3[" + a + "][0]: " + date_of_birth3[a][0]);
                System.out.println("date_of_birth3[" + a + "][1]: " + date_of_birth3[a][1]);
                System.out.println("date_of_birth3[" + a + "][2]: " + date_of_birth3[a][2]);
            }
            ...
            System.out.println("works_with_commision: " + works_with_commision);
