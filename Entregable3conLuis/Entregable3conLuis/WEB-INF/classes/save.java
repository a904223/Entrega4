...
public class save extends HttpServlet {
    ...
    public void doGet (HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
          ...
          try{
			...
			String sql = "INSERT INTO SupplierOrders (SupplierName, CIF, Telephone, AccountingDate, DeliveryDate) VALUES (";
			sql +=  "'" + SupplierName + "'";
			sql +=  ",'" + CIF + "'";
			sql +=  ",'" + Telephone + "'";
			sql +=  ",'" + AccountingDate + "'";
			...
			String sql3= "SELECT MAX(OrderID) As maximo FROM SupplierOrders";
			...
			for (int j=0;j<counter;j++) {
				String sql2 = "INSERT INTO OrderLines (OrderID, ProductName, Quantity, UnitPrice, TotalPrice) VALUES (";
				sql2 +=  "'" + OrderID + "'";
				sql2 +=  ",'" + ProductName[j] + "'";
				sql2 +=  ",'" + Quantity[j] + "'";
				sql2 +=  ",'" + UnitPrice[j] + "'";
