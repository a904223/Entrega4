...
public class ModProduct extends HttpServlet {
  ...
  public void doGet (HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
	...
	toClient.println("<h1 align=\"center\">MODIFY Product</h1>");
	...
	toClient.println("<form method=\"get\" action=\"UpdateProduct\" >");
	toClient.println("<table cellspacing=\"1\" cellpadding=\"1\" border=\"0\" align=\"right\" width=\"80%\" summary=\"\">");
	toClient.println("<tbody>");
	toClient.println("<tr>");
	toClient.println("<td><font face=\"Agency FB\">Product Id</font></td>");
	toClient.println("<td align=\"left\">" +Id+ "</td>");
	toClient.println("</tr>");
	toClient.println("<input type=\"Hidden\" name=\"Id\"  value=\""+Id+"\"/>");
	toClient.println("<tr>");
	toClient.println("<td><font face=\"Agency FB\">Product Name</font></td>");
	toClient.println("<td align=\"left\"><input type=\"text\" name=\"Name\" value=\"" + Name + "\" ></td>");
	toClient.println("</tr>");
	toClient.println("<tr>");
	toClient.println("<td><font face=\"Agency FB\">Sell Price</font></td>");
	toClient.println("<td align=\"left\"><input type=\"text\" name=\"Sell\" value=\"" + Sell + "\" ></td>");
	toClient.println("</tr>");
	toClient.println("<tr>");
	toClient.println("<td><font face=\"Agency FB\">Buy Price</font></td>");
	toClient.println("<td align=\"left\"><input type=\"text\" name=\"Buy\" value=\"" + Buy + "\" ></td>");
	toClient.println("</tr>");
	toClient.println("<td align=\"left\"><INPUT class=\"boton grisn\" TYPE=\"submit\" value=\"Update Product\"></td>");
	...
	toClient.println("	<font color=\"black\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"products\">Cancel</a></font>");
